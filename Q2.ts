...
function addItems(name: string, quantity: number, index: number) {
...
function removeItems(name: string, quantity: number, index: number) {
...
function updateQuantities(name: string) {
  let sum = 0;
  for (let i = 0; i < shoppingCart.length; i++) {
